...
<div class="row">
    <?php foreach ($barang->result_array() as $n => $k) : ?>
        <div class="col-6">
            <div class="card">
                <a href="<?= base_url(); ?>assets_2\images\<?= $k['gambar_ut'] ?>" data-popup="lightbox">
                ...
                <div class="card-body">
                    <div class="media-body text-center">
                        ...
                        <button type="button" class="btn btn-block btn-sm bg-teal-400"><i class="icon-cart-add mr-2"></i> Add to cart</button>
                    </div>
                </div>
            </div>
        </div>
